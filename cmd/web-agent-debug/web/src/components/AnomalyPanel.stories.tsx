...
const mockAnomalies: Anomaly[] = [
  {
    ...
    details: 'Event seq 1707053365400000000 references turn_id "turn_99" which does not exist in the turn store.',
  ...
  },
  {
    ...
    details: 'tool.result event lacks tool_call_id field. Cannot correlate to originating tool.start event.',
  ...
  },
  {
    ...
    details: 'Block at index 3 has metadata key "geppetto.usage@v1" with invalid value type. Expected object, got string.',
...
export const ErrorsOnly: Story = {
  args: {
    anomalies: mockAnomalies.filter(a => a.severity === 'error'),
    isOpen: true,
    onClose: () => {},
  },
};
...
export const ManyAnomalies: Story = {
  args: {
    anomalies: [
      ...mockAnomalies,
      ...mockAnomalies.map((a, i) => ({ ...a, id: `dup_${i}_${a.id}` })),
      ...mockAnomalies.map((a, i) => ({ ...a, id: `dup2_${i}_${a.id}` })),
    ],
    isOpen: true,
    onClose: () => {},
  },
